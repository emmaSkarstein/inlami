...
\vdots\\
\texttt{NA}\\
\end{bmatrix}}_{\texttt{beta.0}} + \underbrace{\begin{bmatrix} 
1\\
\vdots\\
1000\\
\texttt{NA}\\
...
\vdots\\
\texttt{NA}\\
\end{bmatrix}}_{\texttt{beta.x}} + \underbrace{\begin{bmatrix} 
0.98\\
\vdots\\
0.77\\
\texttt{NA}\\
...
\vdots\\
-1\\
\end{bmatrix}}_{\texttt{weight.x}} + \underbrace{\begin{bmatrix} 
\texttt{NA}\\
\vdots\\
\texttt{NA}\\
\texttt{NA}\\
...
\vdots\\
1\\
\end{bmatrix}}_{\texttt{alpha.0}} + \underbrace{\begin{bmatrix} 
\texttt{NA}\\
\vdots\\
\texttt{NA}\\
\texttt{NA}\\
...
\vdots\\
1000\\
\end{bmatrix}}_{\texttt{id.r}} + \underbrace{\begin{bmatrix} 
\texttt{NA}\\
\vdots\\
\texttt{NA}\\
1\\
...
\vdots\\
-1\\
\end{bmatrix}}_{\texttt{weight.r}} + \underbrace{\begin{bmatrix} 
\texttt{NA}\\
\vdots\\
\texttt{NA}\\
\texttt{NA}\\
